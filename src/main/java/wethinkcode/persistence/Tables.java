...
public class Tables {
    ...
    public boolean createGenres() {
        String sql = "CREATE TABLE Genres (code TEXT NOT NULL PRIMARY KEY,description TEXT NOT NULL);";
     ...
     * 3.1 Complete this method
     *
     * Execute an SQL statement containing an SQL command to create a table.
